    ...
    <div id="skills" className="px-8 md:px-16 lg:px-32 py-20 bg-[#0d1117] text-white scroll-mt-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center mb-16">
          <div className="text-center text-4xl md:text-5xl font-bold mb-3">{t('skills.title')}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {Object.entries(skillCategories).map(([category, skills]) => (
            <FadeInSection key={category}>
              <div className="bg-gray-800/60 rounded-xl p-6 border border-[#30363d] hover:border-blue-500 transition-all duration-500 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/20">
                {/* Category Title */}
