export const translations = {
  es: {
    ...
    "experience.webDeveloperDesigner.title": "Desarrollador Web y Diseñador",
    ...
    "projects.flagMatchingGame.title": "Flag Matching Game",
    "projects.flagMatchingGame.description": "Un juego web simple y divertido donde los jugadores ponen a prueba su conocimiento de geografía emparejando países con sus banderas.",
  ...
  en: {
    ...
    'hero.description': 'Full-stack software developer with a strong focus on backend development. I build robust, scalable applications using modern technologies and best practices.',
    ...
    // About Highlights
    'about.highlight.cleanCode.title': 'Clean Code',
    'about.highlight.cleanCode.description': 'Writing maintainable and scalable solutions',
    'about.highlight.fullStack.title': 'Full-Stack',
    'about.highlight.fullStack.description': 'Expertise in frontend and backend development',
    'about.highlight.fastLearner.title': 'Fast Learner',
    'about.highlight.fastLearner.description': 'Always eager to learn new technologies',
    'about.highlight.teamPlayer.title': 'Team Player',
    'about.highlight.teamPlayer.description': 'Excel in collaborative environments',

    // Experience
    "experience.title": "Experience",
      
    "experience.webDeveloperDesigner.title": "Web Developer & Designer",
    "experience.webDeveloperDesigner.business": "Recreaciones Noa",
    "experience.webDeveloperDesigner.time": "Oct 2025 - Dec 2025",
    "experience.webDeveloperDesigner.role": "Freelancer",
    ...
    "experience.webDeveloperDesigner.skills": "Skills",
    ...
    "projects.techStoreManager.title": "Tech Store Manager",
    "projects.techStoreManager.description": "A modern and responsive inventory management system where store owners can track products and manage stock levels.",

    "projects.moviesWebLibrary.title": "Movies+ Web Library",
    "projects.moviesWebLibrary.description": "A movie catalog that contains a wide variety of films provided by The Movie Database (TMDB) API.",

    "projects.flagMatchingGame.title": "Flag Matching Game",
    "projects.flagMatchingGame.description": "A simple and fun web game where players test their geography knowledge by matching countries with their flags.",
